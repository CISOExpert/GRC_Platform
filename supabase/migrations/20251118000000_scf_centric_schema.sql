-- ============================================================================
-- GRC Unified Platform - SCF-Centric Schema Migration
-- Migration: 20251118000000_scf_centric_schema.sql
-- Purpose: Implement complete SCF-based architecture with ICM, C|P-RMM, C|P-CMM
-- ============================================================================

-- This migration builds upon the original schema and adds all SCF-centric tables
-- Original tables (organizations, users, organization_members, frameworks) are retained
-- New tables position SCF controls as the central hub for all GRC operations
